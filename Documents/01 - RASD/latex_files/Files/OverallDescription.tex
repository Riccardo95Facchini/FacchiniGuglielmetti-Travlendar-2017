...
\item Allow the user to state which vehicles he/she prefers to use and the owned ones.
\item Set breaks of a given duration in a variable length interval.
\item Compute the optimal travel plan given the user's preferences and external events.
